...
export const translations = {
  tr: {
    ...
    "conversion.fileTooLargeDesc": "Dosya çok büyük ({size}MB). FFmpeg.wasm maksimum 50MB dosya boyutunu destekler. Lütfen daha küçük bir dosya seçin, WebCodecs API destekleyen tarayıcı kullanın (Chrome/Edge) veya komut satırından FFmpeg kullanın.",
    "conversion.webcodecsNotSupported": "WebCodecs API desteklenmiyor. Lütfen Chrome/Edge tarayıcısı kullanın.",
    "conversion.gpuAcceleration": "GPU acceleration ile hızlı dönüştürme",
    "conversion.fileTooLargeTooltip": "Dosya çok büyük (max 50MB) - WebCodecs API destekleyen tarayıcı kullanın",
    "conversion.convertAndDownload": "Video'yu dönüştür ve indir",
    
    // Converter Page
    "converter.title": "Video Dönüştürücü",
    "converter.subtitle": "Video dosyalarınızı tarayıcınızda dönüştürün - GPU acceleration desteği ile",
    "converter.uploadTitle": "Video Dosyası",
    "converter.uploadDescription": "Dönüştürmek istediğiniz video dosyasını seçin",
    ...
    "converter.settingsDescription": "Codec, kalite ve diğer parametreleri ayarlayın",
    ...
    "converter.bitrateHint": "Örnek: 5M (5 Mbps) veya 2000k (2000 Kbps). Boş bırakırsanız CRF/Quality kullanılır.",
    "converter.crfHint": "CRF değeri: 0-18 (kayıpsız), 19-23 (yüksek kalite), 24-28 (iyi kalite), 29+ (düşük kalite). Önerilen: 23",
    ...
    "converter.qualityHint": "Quality değeri: 30-35 (yüksek kalite), 36-40 (iyi kalite), 41-45 (orta kalite). Önerilen: 30-35",
    ...
    "converter.preset.ultrafast.desc": "Çok hızlı encoding, düşük sıkıştırma. Canlı yayın ve hızlı testler için uygundur.",
    "converter.preset.fast.desc": "Hızlı encoding, orta sıkıştırma. Genel kullanım için iyi bir denge.",
    "converter.preset.medium.desc": "Varsayılan preset. Hız ve sıkıştırma arasında iyi denge.",
    "converter.preset.slow.desc": "Yavaş encoding, en iyi sıkıştırma. Dosya boyutu önemliyse ve zaman varsa önerilir.",
    "converter.audioCodec.aac": "AAC",
    "converter.audioCodec.opus": "Opus",
    "converter.audioCodec.mp3": "MP3",
    "converter.framerate": "Framerate (FPS)",
    "converter.framerateHint": "Video framerate. Boş bırakırsanız orijinal framerate kullanılır.",
    "converter.pixelFormat": "Pixel Format",
    "converter.pixelFormat.yuv420p": "YUV 4:2:0 (En yaygın, uyumluluk için önerilir)",
    "converter.pixelFormat.yuv422p": "YUV 4:2:2 (Daha iyi renk, daha büyük dosya)",
    ...
    "converter.pixelFormatHint": "Pixel format video renk derinliğini belirler. YUV420p çoğu cihaz için önerilir.",
    ...
    "converter.profileHint": "Codec profile'ı. High profile modern cihazlar için önerilir.",
    "converter.level": "Level",
    "converter.levelHint": "Codec level (örn: 4.0, 4.1, 4.2). Boş bırakırsanız otomatik seçilir.",
    "converter.keyframeInterval": "Keyframe Interval (GOP)",
    "converter.keyframeIntervalHint": "Keyframe'ler arası frame sayısı. Düşük değer daha iyi seek desteği, yüksek değer daha iyi sıkıştırma. Önerilen: 250.",
    "converter.tune": "Tune",
    ...
    "converter.tuneHint": "Video içeriğine göre encoding optimizasyonu. Film için 'film', animasyon için 'animation' önerilir.",
    "converter.threads": "Threads",
    "converter.threadsHint": "Encoding için kullanılacak thread sayısı. 0 = otomatik (tüm CPU çekirdekleri).",
    "converter.bframes": "B-Frames",
    "converter.bframesHint": "B-frame sayısı. Daha fazla B-frame = daha iyi sıkıştırma ama daha yavaş encoding. Önerilen: 3.",
    "converter.refFrames": "Reference Frames",
    "converter.refFramesHint": "Referans frame sayısı. Daha fazla = daha iyi kalite ama daha fazla bellek. Önerilen: 3-5.",
    ...
    "converter.meMethodHint": "Hareket tahmin yöntemi. 'hex' veya 'umh' önerilir.",
    "converter.subMe": "Subpixel Motion Estimation",
    "converter.subMeHint": "Subpixel hareket tahmin seviyesi (1-10). Yüksek değer = daha iyi kalite ama daha yavaş. Önerilen: 7.",
    ...
    "converter.audioSampleRateHint": "Ses örnekleme hızı. 48kHz çoğu video için önerilir.",
    ...
    "converter.audioChannelsHint": "Ses kanal sayısı. Stereo çoğu durum için yeterlidir.",
    "converter.deinterlace": "Deinterlace",
    "converter.deinterlaceHint": "Interlaced video'yu progressive'e dönüştür (eski TV kayıtları için)",
    ...
    "converter.colorSpaceHint": "Renk uzayı. BT.709 çoğu HD video için önerilir.",
    ...
    "converter.colorRangeHint": "Renk aralığı. PC (Full) daha geniş renk aralığı sağlar.",
    "converter.videoFilter": "Custom Video Filter",
    "converter.videoFilterHint": "Özel FFmpeg video filter'ı (örn: eq=contrast=1.2:brightness=0.1)",
    "conversion.webcodecsError": "WebCodecs dönüştürme hatası ({size}MB dosya için). Lütfen tekrar deneyin veya daha küçük bir dosya kullanın.",
    "conversion.webcodecsLargeFileError": "WebCodecs büyük dosya ({size}MB) için başarısız oldu. WebCodecs API bellek sınırlamaları olabilir. Lütfen daha küçük bir dosya deneyin veya komut satırından FFmpeg kullanın.",
    "conversion.fsError": "Dosya sistemi hatası ({size}MB dosya). FFmpeg.wasm bellek sınırlamaları nedeniyle bu dosyayı işleyemiyor. Lütfen daha küçük bir dosya deneyin, WebCodecs API destekleyen tarayıcı kullanın (Chrome/Edge) veya komut satırından FFmpeg kullanın.",
    "conversion.emptyOutput": "Encoding başarısız oldu - çıktı dosyası boş. Lütfen ayarları kontrol edin (özellikle codec ve profile ayarlarını) ve tekrar deneyin.",
  },
  en: {
    // Navigation
    "nav.home": "Home",
    ...
    "conversion.fileTooLargeDesc": "File too large ({size}MB). FFmpeg.wasm supports maximum 50MB file size. Please select a smaller file, use a browser that supports WebCodecs API (Chrome/Edge), or use FFmpeg from command line.",
    "conversion.webcodecsNotSupported": "WebCodecs API is not supported. Please use Chrome/Edge browser.",
    "conversion.gpuAcceleration": "Fast conversion with GPU acceleration",
    "conversion.fileTooLargeTooltip": "File too large (max 50MB) - Use a browser that supports WebCodecs API",
    "conversion.convertAndDownload": "Convert and download video",
    
    // Converter Page (English)
    "converter.title": "Video Converter",
    "converter.subtitle": "Convert your video files in the browser - with GPU acceleration support",
    ...
    "converter.settingsDescription": "Adjust codec, quality and other parameters",
    ...
    "converter.bitrateHint": "Example: 5M (5 Mbps) or 2000k (2000 Kbps). Leave empty to use CRF/Quality.",
    "converter.crfHint": "CRF value: 0-18 (lossless), 19-23 (high quality), 24-28 (good quality), 29+ (low quality). Recommended: 23",
    "converter.qualityHint": "Quality value: 30-35 (high quality), 36-40 (good quality), 41-45 (medium quality). Recommended: 30-35",
    ...
    "converter.preset.ultrafast.desc": "Very fast encoding, low compression. Suitable for live streaming and quick tests.",
    "converter.preset.fast.desc": "Fast encoding, medium compression. Good balance for general use.",
    "converter.preset.medium.desc": "Default preset. Good balance between speed and compression.",
    "converter.preset.slow.desc": "Slow encoding, best compression. Recommended when file size is important and time is available.",
    "converter.audioCodec.aac": "AAC",
    "converter.audioCodec.opus": "Opus",
    "converter.audioCodec.mp3": "MP3",
    "converter.framerate": "Framerate (FPS)",
    "converter.framerateHint": "Video framerate. Leave empty to use original framerate.",
    "converter.pixelFormat": "Pixel Format",
    "converter.pixelFormat.yuv420p": "YUV 4:2:0 (Most common, recommended for compatibility)",
    ...
    "converter.pixelFormatHint": "Pixel format determines video color depth. YUV420p is recommended for most devices.",
    "converter.profile": "Profile",
    ...
    "converter.profileHint": "Codec profile. High profile is recommended for modern devices.",
    "converter.level": "Level",
    "converter.levelHint": "Codec level (e.g., 4.0, 4.1, 4.2). Leave empty for auto selection.",
    "converter.keyframeInterval": "Keyframe Interval (GOP)",
    "converter.keyframeIntervalHint": "Number of frames between keyframes. Lower value = better seek support, higher value = better compression. Recommended: 250.",
    "converter.tune": "Tune",
    ...
    "converter.tuneHint": "Encoding optimization based on video content. 'film' for films, 'animation' for animations.",
    "converter.threads": "Threads",
    "converter.threadsHint": "Number of threads to use for encoding. 0 = auto (all CPU cores).",
    "converter.bframes": "B-Frames",
    "converter.bframesHint": "Number of B-frames. More B-frames = better compression but slower encoding. Recommended: 3.",
    "converter.refFrames": "Reference Frames",
    "converter.refFramesHint": "Number of reference frames. More = better quality but more memory. Recommended: 3-5.",
    "converter.meMethod": "Motion Estimation",
    ...
    "converter.meMethodHint": "Motion estimation method. 'hex' or 'umh' recommended.",
    "converter.subMe": "Subpixel Motion Estimation",
    "converter.subMeHint": "Subpixel motion estimation level (1-10). Higher = better quality but slower. Recommended: 7.",
    "converter.audioSampleRate": "Audio Sample Rate",
    ...
    "converter.audioSampleRateHint": "Audio sampling rate. 48kHz recommended for most videos.",
    "converter.audioChannels": "Audio Channels",
    "converter.audioChannels.auto": "Auto (Original)",
    "converter.audioChannels.mono": "Mono",
    "converter.audioChannels.stereo": "Stereo",
    "converter.audioChannels.surround": "5.1 Surround",
    "converter.audioChannelsHint": "Number of audio channels. Stereo is sufficient for most cases.",
    "converter.deinterlace": "Deinterlace",
    "converter.deinterlaceHint": "Convert interlaced video to progressive (for old TV recordings)",
    "converter.denoise": "Denoise",
    ...
    "converter.colorSpace.bt2020": "UHDTV Standard",
    "converter.colorSpace.smpte170m": "SDTV Standard",
    "converter.colorSpaceHint": "Color space. BT.709 recommended for most HD videos.",
    "converter.colorRange": "Color Range",
    "converter.colorRange.auto": "Auto",
    "converter.colorRange.tv": "Limited (16-235)",
    "converter.colorRange.pc": "Full (0-255)",
    "converter.colorRangeHint": "Color range. PC (Full) provides wider color range.",
    "converter.videoFilter": "Custom Video Filter",
    "converter.videoFilterHint": "Custom FFmpeg video filter (e.g., eq=contrast=1.2:brightness=0.1)",
    "conversion.webcodecsError": "WebCodecs conversion error for large file ({size}MB). Please try again or use a smaller file.",
    "conversion.webcodecsLargeFileError": "WebCodecs failed for large file ({size}MB). WebCodecs API may have memory limitations. Please try with a smaller file or use command-line FFmpeg.",
    "conversion.fsError": "File system error ({size}MB file). FFmpeg.wasm cannot process this file due to memory limitations. Please try a smaller file, use a browser that supports WebCodecs API (Chrome/Edge), or use FFmpeg from command line.",
    "conversion.emptyOutput": "Encoding failed - output file is empty. Please check your settings (especially codec and profile settings) and try again.",
  },
} as const;
